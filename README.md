...
<head>
    ...
    <link rel="preload" as="style" href="http://127.0.0.1:8000/build/assets/app-CRaYrJ9t.css" /><link rel="stylesheet" href="http://127.0.0.1:8000/build/assets/app-CRaYrJ9t.css" />    <style>
        :root {
            --primary: #0A2472;
            --secondary: #0A2472;
            --accent: #F5C542;
...
<div style="background:#0E2877; color:white; font-size:13px; position:relative; z-index:200;">
  ...
  <span style="opacity:.5;">|</span>
      ...
      <a href="http://127.0.0.1:8000/login" style="color:white; text-decoration:none; font-weight:600;">Login</a>
    <a href="http://127.0.0.1:8000/register" style="
      color:#0E2877;
      background:white;
      padding:3px 10px;
      border-radius:999px;
...
<a href="http://127.0.0.1:8000" class="flex items-center gap-2 ml-2">
    <!-- Logo -->
    <img src="http://127.0.0.1:8000/images/logo.png" alt="Glokamart" class="w-14 h-14 sm:w-29 sm:h-29 object-contain">
    <!-- Nama -->
...
<div x-data="bannerSlider(3)"
    ...
    <div class="flex transition-transform duration-500 ease-in-out"
         :style="'transform: translateX(-' + current * 100 + '%)'">
                    ...
                    <div class="w-full flex-shrink-0 h-[220px] sm:h-[300px] md:h-[380px]">
                        ...
                        <source src="http://127.0.0.1:8000/storage/banners/OmHUIsWY8Sq072cNLAoOUAPaf02Rn3vpckJGIT5w.mp4">
                    </video>
                    ...
                    <div class="w-full flex-shrink-0 h-[220px] sm:h-[300px] md:h-[380px]">
                                    ...
                                    <img src="http://127.0.0.1:8000/storage/banners/zw94H28fGMBC4s60p0HuyZ7ki5diAeavuRBuwB8W.png"
                         class="w-full h-full object-cover">
                    ...
                    <div class="w-full flex-shrink-0 h-[220px] sm:h-[300px] md:h-[380px]">
                                    ...
                                    <img src="http://127.0.0.1:8000/storage/banners/ykpeMuSMlykFDvS5vIns57yvE2I426u2qLRPNedW.png"
                         class="w-full h-full object-cover">
    ...
    <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2">
                    <div @click="goTo(0)"
                 :class="current === 0 ? 'bg-white scale-110' : 'bg-white/50'"
                 class="w-3 h-3 rounded-full cursor-pointer transition">
            </div>
                    <div @click="goTo(1)"
                 :class="current === 1 ? 'bg-white scale-110' : 'bg-white/50'"
                 class="w-3 h-3 rounded-full cursor-pointer transition">
            </div>
                    <div @click="goTo(2)"
                 :class="current === 2 ? 'bg-white scale-110' : 'bg-white/50'"
                 class="w-3 h-3 rounded-full cursor-pointer transition">
            </div>
            </div>
...
<div class="categories flex justify-around items-center flex-wrap gap-4 p-6 bg-white rounded-xl shadow-sm">
            <a href="http://127.0.0.1:8000/kategori/kamera" 
           class="category text-center block hover:scale-105 transition-transform">

            <img src="http://127.0.0.1:8000/images/kamera.png" 
                 alt="kamera" 
            ...
            <a href="http://127.0.0.1:8000/kategori/lensa" 
           class="category text-center block hover:scale-105 transition-transform">

            <img src="http://127.0.0.1:8000/images/lensa.png" 
                 alt="lensa" 
                 class="h-14 w-14 mx-auto object-contain mb-2">
            ...
            <a href="http://127.0.0.1:8000/kategori/paket-sewa" 
           class="category text-center block hover:scale-105 transition-transform">

            <img src="http://127.0.0.1:8000/images/paket-sewa.png" 
                 alt="paket sewa" 
                 class="h-14 w-14 mx-auto object-contain mb-2">
...
<!--<s
  ...
  <div class="flex gap-4 overflow-x-auto px-6">
        ...
        <img src="https://picsum.photos/200?random=21" class="rounded mb-2">
        <p class="text-sm font-medium">Produk 1</p>
        <p class="text-yellow-600 font-semibold text-sm">Rp 19K</p>
      </div>
          <div class="min-w-[160px] bg-gray-100 rounded p-3">
        <img src="https://picsum.photos/200?random=22" class="rounded mb-2">
        <p class="text-sm font-medium">Produk 2</p>
        <p class="text-yellow-600 font-semibold text-sm">Rp 51K</p>
      </div>
          <div class="min-w-[160px] bg-gray-100 rounded p-3">
        <img src="https://picsum.photos/200?random=23" class="rounded mb-2">
        <p class="text-sm font-medium">Produk 3</p>
        <p class="text-yellow-600 font-semibold text-sm">Rp 65K</p>
      </div>
          <div class="min-w-[160px] bg-gray-100 rounded p-3">
        <img src="https://picsum.photos/200?random=24" class="rounded mb-2">
        <p class="text-sm font-medium">Produk 4</p>
        <p class="text-yellow-600 font-semibold text-sm">Rp 15K</p>
      </div>
          <div class="min-w-[160px] bg-gray-100 rounded p-3">
        <img src="https://picsum.photos/200?random=25" class="rounded mb-2">
        <p class="text-sm font-medium">Produk 5</p>
        <p class="text-yellow-600 font-semibold text-sm">Rp 54K</p>
      </div>
          <div class="min-w-[160px] bg-gray-100 rounded p-3">
        <img src="https://picsum.photos/200?random=26" class="rounded mb-2">
        <p class="text-sm font-medium">Produk 6</p>
        <p class="text-yellow-600 font-semibold text-sm">Rp 96K</p>
      </div>
      </div>
</section>-->
    ...
    <div class="product-card bg-white border rounded shadow p-4 relative hover:shadow-lg transition">
        ...
        <div class="product-info">
            ...
            <
                ...
                <input type="hidden" name="_token" value="7ZwsN6YC5rrmYxqXioCGdhA5oWywKU2iR9b7DH1k" autocomplete="off">                <button type="submit" class="bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600 transition w-full">
                    Tambah ke Keranjang
                </button>
            </form>
        </div>
